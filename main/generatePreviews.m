...
uibutton(MaskOverlayPreviewPanel, 'push', 'FontName', 'Roboto Medium', 'FontSize', 10, 'Icon', 'baseline_close_white_48dp.png', 'IconAlignment', 'top', 'Text',...
    ...
    [parentPos(3)/5 + 10 + buttonWidth ,5, 100, 50], 'BackgroundColor', [176 0 32]./255);
%Accpet Button
uibutton(MaskOverlayPreviewPanel, 'push', 'FontName', 'Roboto Medium', 'FontSize', 10, 'Icon', 'baseline_done_white_48dp.png', 'IconAlignment', 'top', 'Text',...
    ...
    [parentPos(3) - 2*buttonWidth - 10 ,5, 100, 50], 'BackgroundColor', [8 226 55]./255);
%Close Button
uibutton(MaskOverlayPreviewPanel, 'push', 'FontName', 'Roboto Medium', 'FontSize', 14, 'Text', 'CLOSE', 'FontColor', [1 1 1], 'ButtonPushedFcn', ...
    {@closeClicked, MaskOverlayPreviewPanel},'Position', [parentPos(3)/5 + 15 + 2.5*buttonWidth, 5, 100, 50], 'BackgroundColor', [0 0.29 1]);
